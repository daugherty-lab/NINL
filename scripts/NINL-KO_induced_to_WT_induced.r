...
# R script for DESeq2 processing of WT_induced and NINL-KO_induced
...
##  ----config---- 
species <- "NINL-KO_induced_to_WT_induced"
...
## ----relevel-------------------------------------------------------------
dds$Condition <- relevel(dds$Condition, ref = "WT_induced")
...
res <- results(dds, contrast=c("Condition","NINL-KO_induced","WT_induced"))
...
write.csv(as.data.frame(res), file=("out/processed/Condition_NINL-KO_induced_vs_WT_induced.csv"))
