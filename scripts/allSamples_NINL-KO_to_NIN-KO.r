...
# R script for DESeq2 processing of NIN-KO and NINL-KO
...
res <- results(dds, contrast=c("Condition","NINL-KO","NIN-KO"))
...
write.csv(as.data.frame(res), file=("out/processed/Condition_NINL-KO_vs_NIN-KO.csv"))
