...
# R script for DESeq2 processing of WT and WT_induced
...
res <- results(dds, contrast=c("Condition","WT_induced","WT"))
...
write.csv(as.data.frame(res), file=("out/processed/Condition_WT_induced_vs_WT.csv"))
