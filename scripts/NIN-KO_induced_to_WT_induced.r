...
# R script for DESeq2 processing of WT_induced and NIN-KO_induced
...
##  ----config---- 
species <- "NIN-KO_induced_to_WT_induced"
...
res <- results(dds, contrast=c("Condition","NIN-KO_induced","WT_induced"))
...
write.csv(as.data.frame(res), file=("out/processed/Condition_NIN-KO_induced_vs_WT_induced.csv"))
