...
# R script for DESeq2 processing of WT and NIN-KO
...
res <- results(dds, contrast=c("Condition","NIN-KO","WT"))
...
write.csv(as.data.frame(res), file=("out/processed/Condition_NIN-KO_vs_WT.csv"))
