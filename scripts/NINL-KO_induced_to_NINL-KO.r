...
# R script for DESeq2 processing of NINL-KO and NINL-KO_induced
...
##  ----config---- 
species <- "NINL-KO_induced_to_NINL-KO"
...
## ----relevel-------------------------------------------------------------
dds$Condition <- relevel(dds$Condition, ref = "NINL-KO")
...
res <- results(dds, contrast=c("Condition","NINL-KO_induced","NINL-KO"))
...
write.csv(as.data.frame(res), file=("out/processed/Condition_NINL-KO_induced_vs_NINL-KO.csv"))
